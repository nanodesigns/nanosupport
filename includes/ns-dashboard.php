...
function nanosupport_widget_callback() { ?>
    <section id="nanosupport-widget">
        ...
        <div class="ns-text-center">
            <?php printf( __( '<a href="%1s" targe="_blank">Rate us %2s</a>', 'nanosupport' ), 'https://wordpress.org/support/view/plugin-reviews/nanosupport#postform' , '<i class="ns-icon-star-filled"></i><i class="ns-icon-star-filled"></i><i class="ns-icon-star-filled"></i><i class="ns-icon-star-filled"></i><i class="ns-icon-star-filled"></i>' ); ?> | <?php printf( __( '<a href="%1s" targe="_blank">Get Support</a>', 'nanosupport' ), 'https://wordpress.org/support/plugin/nanosupport' ); ?> | <a href="http://nanodesignsbd.com?ref=nanosupport" target="_blank" title="nanodesigns - developer of the plugin"><strong>nano</strong>designs</a>
        </div>
